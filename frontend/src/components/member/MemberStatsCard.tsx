  ...
  return (
    <div className="bg-dark-900 border border-dark-800 dark:bg-dark-900 dark:border-dark-800 light:bg-white light:border-gray-200 rounded-xl p-4 sm:p-6 shadow-sm">
      ...
      <div className="space-y-3 sm:space-y-4">
        {/* Objetivo */}
        {hasGoal ? (
          <div className="p-3 sm:p-4 bg-primary-500/10 border border-primary-500/20 rounded-lg">
            <div className="flex items-center gap-2 sm:gap-3">
              <span className="text-2xl sm:text-3xl">{GOAL_EMOJIS[profile.goal_type!]}</span>
            ...
            {profile.goal_notes && (
              <p className="text-xs sm:text-sm text-dark-300 dark:text-dark-300 light:text-gray-700 mt-2 sm:mt-3 italic">
                "{profile.goal_notes}"
              </p>
            )}
          </div>
